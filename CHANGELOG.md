...
- **Seven weather types** — Rain, Snow, Ash, Embers, Sandstorm, Fog, and Leaves. Each has its own top-down particle behavior, default color, and motion characteristics. Pick any type per group and tweak from there.
