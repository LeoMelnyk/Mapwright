...
- **Catalog grew from ~245 to 1119 props**, covering 70+ room types. Every prop includes full placement metadata (footprint, shadow, `blocks_light`, `lights`, `placement`, `room_types`, `typical_count`, `clusters_with`), and light-emitting props automatically glow when placed.
- **Room coverage** — furniture and domestic life (kitchens, taverns, bedrooms, nurseries, libraries, farmhouses, tenements, noble chambers, mansion halls), workshops and industry (smithies, forges, foundries, breweries, cooperages, tanneries, glassworks, kilns, refineries, artificer labs), nautical (ship galleys, captain's cabins, cargo holds, gun decks, main decks), dungeons and prisons (oubliettes, interrogation rooms, prison blocks, monster lairs, slime pits, spider lairs), wilderness and camps (traveler campsites, charcoal-burner camps, druid groves, bog-witch huts, ruined watchtowers), planar and magical (elemental water/air/fire/earth nodes, astral anchors, celestial vaults, fey glades, shadowfell mausoleums, infernal courts, demiplane labs), urban life (market squares and stalls, merchant houses, opium dens, tailor shops), military (command rooms, battlefields, orc and goblin camps), underground (sewers, mines, cisterns, drow outposts, chasm crossings), and events (fairgrounds, bardic halls, temples, bath houses).
