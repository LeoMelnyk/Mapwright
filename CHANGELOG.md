...
- **29 additional props in a third thematic batch** — mill and workshop gear (drive-shaft, grain-hopper, grain-spill, wood-chip-pile, wood-bin), library accessories (bookshelf-tall, bookmark, reading-glasses, wax-seal-kit), a market set (market-stall, market-stall-awning, dog-stray), peasant-household clutter (patched-shirt, worn-shoes, wooden-toy, tin-cup), a shrine and druid cluster (prayer-stone, shrine-stone, ribbon-tied, skull-small, obsidian-shard), goblin and underdark encampment pieces (hide-tarp, torch-totem, chitin-barrier), atmospheric haze (smoke-cloud, dust-cloud), and specialty items (herb-drying-rack, bucket-stained, desk-lamp). Torch-totem and desk-lamp include `lights:` entries so they glow automatically when placed.
- **27 more props in a fourth thematic batch** — Tier 2 stragglers (forge-great with glowing hearth, infernal-chain-hook, pipe-outlet, summoning-pool with purple glow), a nursery set (child-bed, cot-blanket, dollhouse, blocks-pile, candle-night-light with warm glow), battlefield aftermath (broken-spear, broken-sword, arrow-stuck, banner-fallen, helmet-rusted, campfire-abandoned), ballroom finery (chandelier-grand and candelabra-tall both lit, masquerade-mask, flower-arrangement), a campsite cluster (boots-drying, cook-pot-tripod, campfire-cold, log-seat), and pottery workshop items (clay-lump, broken-pot, finished-pot, kiln-brick with glowing firing chamber). Tier 2 of the missing-props list is now effectively complete.
- **50 more props in a fifth thematic batch** — farmhouse-kitchen life (hanging-garlic, hanging-sausage, chopped-vegetables, mixing-bowl, long-spoon, flour-barrel, cat-begging, pantry-door), druid grove wilderness (altar-wooden, antler-offering, bush-berry, fern-cluster, log-fallen, rain-puddle, standing-stones-ring), prison block gear (bars-cell-partition, blood-stain, cell-door, rat-nest, ration-bowl, rusted-manacle, straw-pile), cave biome (bat-guano, cave-cricket, crystal-glow, drip-stain, mineral-vein, mushroom-glow, stalactite-hanging — crystal-glow and mushroom-glow emit light), bath house amenities (bath-pool, massage-table, oil-amphora, plunge-basin, sandal-pair, steam-cloud, towel-folded), alchemy lab equipment (animal-skull, broken-vial, cauldron-small, distillation-setup with lit burner, reagent-jar, specimen-jar-shelf), infernal forge tools (anvil-devil, bellows-giant, glowing-ingot, soul-crucible — all lit where appropriate), and abandoned-cabin decay (broken-bottle, chair-broken, cobweb-cluster, shelf-fallen). The Great Forge (forge-great) was also rebuilt from a rectangular block into a proper twin-hearth masonry furnace with chimney vent, corner quoins, and reinforcement brackets.
- **25 more props in a sixth thematic batch** — nursery toys (rocking-horse, hobby-horse, rag-doll, stuffed-bear, toy-chest, tin-soldier-pile), mansion finery (harpsichord, mirror-tall, potted-palm, bench-upholstered, rug-runner, statue-classical), ruined watchtower decay (brazier-dead, collapsed-stair, skeleton-slumped, watchfire-ring, wild-plant-sprouting), goblin warren markers (junk-pile, bone-totem-small, skull-on-stick, warren-hole), and glassworks tools (blowpipe, glass-furnace with hot glow, marver-slab, finished-vessel).
- **209 more props in a seventh thematic batch** — the first large wave of Tier 3 one-off flavor props, spanning twenty atmospheric settings. Elemental planes get a full treatment: a water node (anemone-glow, coral-pillar, kelp-frond-giant, marid-pavilion, pearl-obelisk, shell-giant, water-node-core), an air node (air-node-vortex, cloud-pillar, djinn-pavilion, floating-stone, lightning-arc-small, storm-altar, wind-chime-giant), and a fire node (basalt-pillar, efreet-brazier-grand, ember-pit, fire-node-core, flame-pillar, lava-fountain, skeleton-charred). An astral-anchor set adds a planar nexus (astral-anchor-stone, dead-god-fragment, floating-candle, githyanki-perch, obelisk-astral, portal-stela, silver-cord-pylon, spelljammer-dock-mooring). Battlefield-recent fills in the grim aftermath (blood-pool, commander-corpse-mounted, corpse-horse, corpse-soldier, pavise, pyre-mass-grave, siege-engine-wrecked) and a fairground-seasonal set brings festive life (bonfire-large, bunting-line, game-booth, lantern-paper, maypole, pie-stand, stage-performance). Noble mansion rooms get four full kits — ballroom (buffet-table, fountain-interior, musicians-dais, painting-large, punch-table), grand hall (banner-heraldic, brass-candlestick, coat-rack-ornate, grand-staircase, statue-noble, tapestry-large, umbrella-stand), dining room (china-cabinet, round-dining-table, serving-trolley, silver-candlestick, tureen), and master bedroom (chamber-pot-stand, crucifix-wall, dressing-screen, hairbrush-set, jewelry-box). Market stalls come alive (canvas-awning, crate-stacked, display-basket, display-rack-fabric, stall-counter, stool-vendor), temple naves get ritual weight (altar-sacrificial, holy-symbol, icon-wall, pulpit, statue-deity, tapestry-religious), and bardic halls fill with music (bouquet, drum-stand, harp, laurel-wreath, lute-stand, music-stand, stage-large). Humanoid camps expand (orc: bedroll-hide, bonfire, butchery-pit, chieftains-throne, prisoner-cage, skull-totem; goblin: cave-mouth-small, rat-carcass, shiny-trinket, spike-pit-hidden, tripwire). Underworld locations get their props (sewer: bridge-wood, grate-shaft-light, grate-wall, scummy-water-pool, sewage-channel; drow outpost: candle-violet, drow-command-slab, drow-weapon-rack, faerzress-sconce, scrying-pool, spider-shrine, spider-silk-drape; mine: cart-track, headframe, mine-shaft, sorting-table, winch-large), as do merchant homes (brass-lamp, chest-ornate, dining-table, rug-oriental) and ship gun decks (cannon-tackle, gun-port, linstock, powder-tub, rammer-rack, shot-garland). Glowing props (anemone-glow, pearl-cluster, pearl-obelisk, water-node-core, fire-node-core, air-node-vortex, brazier-grand, pyre-mass-grave, bonfire-large, lantern-paper, storm-altar, astral-anchor-stone, astral-lantern, portal-stela, obelisk-astral, floating-candle, silver-candlestick, brass-candlestick, faerzress-sconce, scrying-pool, moss-patch-glowing, candle-violet, candle-miner, linstock, grate-shaft-light, ashes-pile, ember-pit, ember-drift, flame-pillar, lava-fountain, molten-pool-small, spider-shrine, lightning-arc-small, spark-burst) emit light via the catalog's `lights:` field automatically when placed.
- **Batch-7 perspective fixes** — 19 props redrawn after visual review to honor the top-down rule. Tall columns (bubble-pillar, coral-pillar, kelp-frond-giant, kelp-strand, pearl-obelisk, silver-cord-pylon, basalt-pillar, cloud-pillar, flame-pillar, obelisk-astral, pillar-floating, portal-stela) changed footprint from `2x1` to `1x1` / `2x2` and are now drawn as radial cross-sections (rings, pyramidions, spreading rosettes) instead of side-elevation shafts. Stuck weapons (weapon-stuck, spear-stuck) now show only the cross-guard / feather tuft poking out of an impact ring rather than a full weapon lying flat. The harp is now drawn edge-on (a thin vertical profile). Bonfire flame converted to concentric rings of fire. Bunting line now shows only the rope plus flag-top edges and a faint drape shadow. Cave mouth is now a dark hole in a rock mass (no side-view depth gradient). Spelljammer mooring has been tightened to a proper top-down bollard with rope coil around its base.
- **Modular sewage-channel and mine-cart-track sets** — the single straight sewer piece now has four matching variants so you can build full networks: 90° turn, T-junction, four-way crossing, and a short 1x1 straight for fine-grained layouts between corners. Mine cart rail gets the same five-piece treatment plus a buffer-stop end cap for track terminations. All junction variants match the straight piece's 0.60-wide channel with 0.12-thick stone lips, so any two pieces snap together cleanly at cell boundaries.
- **Mine cart prop** — `mine-cart` (loaded with coal and ore) and `mine-cart-empty` (weathered-plank bed with coal-dust residue). Both sized to straddle the cart-track rails (1x2 footprint, wheels aligned to the rail positions). Iron-bound wooden chassis with coupling hooks at both ends for linking carts into a train.
- **Removed bridge-wood** — duplicated the built-in bridge tool.
- **Manifest regenerated** — catalog now ships 813 props across 31+ categories (up from 594 at batch 6).
- **46 more props in an eighth thematic batch** — six more room-themed clusters. A pantry set (bottle, jar, grain-sack, sack-stack, hanging-ham, ham-hook-row, pantry-shelf, salt-brick) adds the missing stores any kitchen or dockside warehouse needs, with proper overhead-hanging treatment for the ham rack. A tailor's shop (cutting-table, sewing-bench, fitting-mirror, mannequin, measuring-tape, scissors-shears, buttons-jar, thimble) gives merchant rows and mansion wardrobes a working seamstress nook — the mannequin is drawn as radial shoulder rings rather than a torso silhouette. An opium den (candle-red with warm glow, cushion-pile, opium-couch, opium-pipe, pipe-ash, screen-folding, teacup, teapot) brings low-lit vice to city maps. A glassworks cluster (annealing-oven with residual heat glow, bucket-water, color-rod-bundle, gaffer-bench, jack-tool, sand-bin, sand-spill) complements the existing furnace and blowpipe. A kiln-pottery set (kiln-large with firing glow, drying-rack, apron-clay, clay-dust, pottery-shard, sponge, water-bowl) rounds out the ceramics workshop started in batch 5. And a tannery (tanning-vat, tanning-pit, hide-scraps, leather-stack, fur-clump, lime-bin, lime-dust, scraping-beam) adds the gruesome industrial quarter — three hide-process stations plus the chemical residues they leave on the floor. Catalog size: 859 props.
- **52 more props in a ninth thematic batch** — six room-themed clusters covering domestic and industrial ground. A nursery kit (bookshelf-child, bottle-nursing, building-blocks, hearth-small with a safety fire-guard, lullaby-music-box, nurse-stool, picture-book, screen-painted, spilled-toys, tiny-chair, wardrobe-small) fills out children's quarters with pastel toys and child-scale furniture. A small monster lair (claw-marks-wall, egg-sac, half-eaten-carcass, residual-torch-from-victims, shed-skin, slime-puddle, straw-bed-large, torn-cloak, web-cluster) brings visceral detail — a dropped torch left by a fleeing victim still glows. A slime pit (acid-etched-altar with cutout pits, dissolved-skeleton, dripping-stalactite, ooze-pool, ooze-puddle, rusted-weapon, slime-trail, victim-cocoon) shows real corrosion damage rather than tidy gore — bones dissolve mid-body into green slime, altars have chunks eaten clean out. A demiplane laboratory (arcane-experiment-core with a hovering glowing orb, broken-glassware, homunculus-vat with a floating subject, orrery-magical, reagent-rack, rune-chalk-mark, scroll-stack, spell-component-loose) gives wizard sancta a working-experiment centerpiece. A ship main deck (belaying-pin-rack, cargo-hatch, holystone, longboat-cradle, mast-fore matching the main-mast radial pattern, sail-rolled, ships-ladder, water-barrel) covers the gear that isn't already on the catalog's other ship props. And a great foundry (blast-furnace with a proper concentric-ring fire core, casting-pit of molten iron, ingot-single, iron-scrap, ladle-iron, overhead-crane shown only as beam + trolley from above, sand-mold, tongs-long) scales up the forge for industrial-grade scenes. Blast-furnace, casting-pit, arcane-experiment-core, residual-torch-from-victims, and hearth-small emit light automatically via the catalog's `lights:` field. Catalog size: 911 props.
