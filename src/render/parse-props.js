 ...
 */
export function scaleFactor(transform) {
 ...
 */
export function scanKeyword(tokens, keyword) {
 ...
 */
export function isGradient(cmd) {
 ...
 */
export function parseStyleExtended(tokens, startIndex) {
 ...
 */
export function parseOpacity(token) {
 ...
 */
export function rotatePoint(x, y, rotation, footprint) {
 ...
 */
export function flipCommand(cmd, footprint) {
 ...
 */
export function transformCommand(cmd, rotation, footprint) {
