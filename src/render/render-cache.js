 ...
 */
export function getCachedRoomCells(cells) {
 ...
 */
export function collectRoundedCorners(cells) {
 ...
 * @returns {void}
 */
export function traceArcWedge(ctx, rc, gridSize, transform) {
 ...
 * @returns {void}
 */
export function withTrimVoidClip(ctx, cells, gridSize, transform, fn) {
