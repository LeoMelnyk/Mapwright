 ...
 */
export function buildDd2vtt(pngBuffer, config, canvasWidth, canvasHeight) {
 ...
 */
function extractWallsAndPortals(cells, displayGridSize, offsetX, offsetY, pixelsPerGrid) {
  const walls = [];
  const portals = [];
 ...
 */
function cellToPixelSegment(edge, displayGridSize, offsetX, offsetY, pixelsPerGrid) {
 ...
 */
function extractLights(metadata, displayGridSize, offsetX, offsetY, pixelsPerGrid) {
