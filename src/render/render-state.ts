 ...
 */
export function _t<T>(label: string, fn: () => T): T {
...
let _dirtyRegion: DirtyRegion | null = null;
let _dirtyFullRebuild: boolean = false; // true → must do full rebuild (geometry change, undo, etc.)
...
let _broadcastDirtyRegion: DirtyRegion | null = null;
let _broadcastFullRebuild: boolean = false;

/**
 * Get the current dirty region, or null if a full rebuild is needed.
 * @returns {DirtyRegion|null}
 */
export function getDirtyRegion(): DirtyRegion | null {
 ...
 * @returns {void}
 */
export function consumeDirtyRegion(): void {
  _dirtyRegion = null;
 ...
 * @returns {DirtyRegion|null}
 */
export function getBroadcastDirtyRegion(): DirtyRegion | null {
 ...
 * @returns {DirtyRegion|null}
 */
export function consumeBroadcastDirtyRegion(): DirtyRegion | null {
