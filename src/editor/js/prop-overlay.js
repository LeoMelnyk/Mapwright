 ...
 * @returns {number}
 */
export function resolveZIndex(z) {
  if (typeof z === 'string') {
 ...
 */
export function nextPropId(metadata) {
 ...
 */
export function gridToWorldFeet(row, col, gridSize) {
 ...
 */
export function worldFeetToGrid(x, y, gridSize) {
 ...
 * @returns {boolean}
 */
export function isGridAlignedRotation(rotation) {
 ...
 */
export function effectiveSpan(propDef, rotation) {
 ...
 */
export function getOverlayPropAABB(prop, propDef, gridSize) {
 ...
 */
export function createOverlayProp(metadata, propType, row, col, gridSize, options = {}) {
