 ...
 */
export function classifyStairShape(p1, p2, p3) {
 ...
 */
export function isDegenerate(p1, p2, p3) {
  // Same point check
 ...
 */
export function stairBoundingBox(points) {
 ...
 */
export function getOccupiedCells(vertices) {
  let minRow = Infinity, minCol = Infinity, maxRow = -Infinity, maxCol = -Infinity;
 ...
 */
export function computeHatchLines(points, lineSpacing = 0.2) {
